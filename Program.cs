...
namespace ITextSharpDraft
{
    public class Program
    {
        ...
        {
            //lineCounter = 0; // This should not exceed the numberOfLines
        ...
        public static void Main(string[] args)
        {
            ...
            try
            {
                ...
                string filepathfive = @"C:\Users\Sherwin\Documents\Uni - Work Experience\Watercare Bills\Watercare_Bill_5160098-02_2017_Jan_06.pdf"; // 53
                ...
                */
                ...
                Console.WriteLine("No. of lines on this page: " + lineCounter);
